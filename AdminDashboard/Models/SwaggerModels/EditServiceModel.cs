...
namespace AdminDashboard.Models.SwaggerModels
{
    ...
    /// </summary>
    [DataContract]
        public partial class EditServiceModel :  IEquatable<EditServiceModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EditServiceModel" /> class.
        /// </summary>
        ...
        public EditServiceModel(int? id = default(int?), string name = default(string), string arName = default(string), bool? status = default(bool?), int? serviceTypeID = default(int?), string code = default(string), int? serviceEntityID = default(int?), int? serviceCategoryID = default(int?), string pathClass = default(string), ServiceClassType classType = default(ServiceClassType))
        {
            this.Id = id;
            this.Name = name;
            this.ArName = arName;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EditServiceModel {\n");
        ...
        {
            return this.Equals(input as EditServiceModel);
        }

        /// <summary>
        /// Returns true if EditServiceModel instances are equal
        /// </summary>
        /// <param name="input">Instance of EditServiceModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EditServiceModel input)
        {
            if (input == null)
                return false;
