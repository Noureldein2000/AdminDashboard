...
namespace AdminDashboard.Models.SwaggerModels
{
        ...
        public partial class DenominationTaxesModel :  IEquatable<DenominationTaxesModel>, IValidatableObject
    {
        ...
        public DenominationTaxesModel(int? id = default(int?), int? taxId = default(int?), double? taxValue = default(double?), int? paymentModeId = default(int?), string paymentMode = default(string), int? taxTypeId = default(int?), string taxTypeName = default(string), int? denominationId = default(int?), double? amountFrom = default(double?), double? amountTo = default(double?), DateTime? creationDate = default(DateTime?))
        {
            this.Id = id;
            this.TaxId = taxId;
