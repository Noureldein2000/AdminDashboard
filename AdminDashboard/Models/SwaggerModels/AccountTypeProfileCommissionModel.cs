...
{
    /// <summary>
    /// AccountTypeProfileCommissionModel
    /// </summary>
    [DataContract]
        public partial class AccountTypeProfileCommissionModel :  IEquatable<AccountTypeProfileCommissionModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountTypeProfileCommissionModel" /> class.
        /// </summary>
        ...
        public AccountTypeProfileCommissionModel(int? id = default(int?), int? commissionID = default(int?), int? accountTypeProfileDenominationID = default(int?), string serviceName = default(string), string denomintionName = default(string), string accountTypeName = default(string), string profileName = default(string), double? commissionValue = default(double?), double? amountFrom = default(double?), double? amountTo = default(double?), string paymentModeName = default(string), string commissionTypeName = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountTypeProfileCommissionModel {\n");
        ...
        {
            return this.Equals(input as AccountTypeProfileCommissionModel);
        }

        /// <summary>
        /// Returns true if AccountTypeProfileCommissionModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountTypeProfileCommissionModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountTypeProfileCommissionModel input)
        {
            if (input == null)
                return false;
