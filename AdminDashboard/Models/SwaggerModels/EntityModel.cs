...
namespace AdminDashboard.Models.SwaggerModels
{
        ...
        public partial class EntityModel :  IEquatable<EntityModel>, IValidatableObject
    {
        ...
        public EntityModel(int? id = default(int?), string name = default(string), string nameAr = default(string))
        {
            this.Id = id;
            this.Name = name;
            this.NameAr = nameAr;
        ...
        {
            return this.Equals(input as EntityModel);
        }

        /// <summary>
        /// Returns true if EntityModel instances are equal
        /// </summary>
        /// <param name="input">Instance of EntityModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntityModel input)
        {
            if (input == null)
                return false;
