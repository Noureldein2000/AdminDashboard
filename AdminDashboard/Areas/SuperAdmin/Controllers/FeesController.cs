...
namespace AdminDashboard.Areas.SuperAdmin.Controllers
{
    ...
    public class FeesController : Controller
    {
        ...
        //[HttpGet]
        //public async Task<IActionResult> AccountFeesIndex(int? accountId = null, int page = 1)
        //{
        ...
        //[HttpGet]
        //public IActionResult CreateAccountFee(int accountId)
        //{
        ...
        //public IActionResult CreateAccountFee(CreateAccountFeesViewModel model)
        //{
        ...
        //    return RedirectToAction(nameof(AccountFeesIndex), new { accountId = model.AccountId });
        //}
        ...
        //    return RedirectToAction(nameof(AccountFeesIndex), new { accountId = accountId });
        //}
